...
const ProductDetailPopup: React.FC<ProductDetailPopupProps> = ({
  ...
  return (
    ...
    >
      <div className="relative bg-gradient-to-br from-back-800 to-back-900 border border-gray-700/50 rounded-2xl shadow-2xl max-w-2xl w-full mx-4 p-6 animate-in fade-in-50 overflow-y-auto max-h-[90vh]">
        {/* Close Button */}
        <button
          onClick={onClose}
